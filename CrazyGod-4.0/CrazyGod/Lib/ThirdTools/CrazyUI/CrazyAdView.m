...
+ (id)adScrollViewWithFrame:(CGRect)frame imageLinkURL:(NSArray *)imageLinkURL pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    CrazyAdView * adView = [[CrazyAdView alloc]initWithFrame:frame];
...
+ (id)adScrollViewWithFrame:(CGRect)frame imageLinkURL:(NSArray *)imageLinkURL placeHoderImageName:(NSString *)imageName pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    CrazyAdView * adView = [CrazyAdView adScrollViewWithFrame:frame imageLinkURL:imageLinkURL   pageControlShowStyle:PageControlShowStyle];
...
+ (id)adScrollViewWithFrame:(CGRect)frame localImageLinkURL:(NSArray *)imageLinkURL pageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    CrazyAdView * adView = [CrazyAdView adScrollViewWithFrame:frame imageLinkURL:imagePaths   pageControlShowStyle:PageControlShowStyle];
    return adView;
}
...
- (void)setimageLinkURL:(NSArray *)imageLinkURL
{
    ...
    [_leftImageView sd_setImageWithURL:[NSURL URLWithString:@"http://123.56.111.37/templates/default/images/imgdata/slideimg_5.jpg"]  placeholderImage:self.placeHoldImage completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
